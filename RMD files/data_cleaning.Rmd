...
aus_data_rates<-aus_data %>% select("Disease"|"Month"|"ACT_rate":"Aust_rate")%>% rename("ACT"="ACT_rate", "NSW"="NSW_rate", "NT"="NT_rate", "Qld"="Qld_rate", "SA"="SA_rate", "Tas"= "Tas_rate", "Vic"= "Vic_rate", "WA"= "WA_rate", "Australia"= "Aust_rate")%>% arrange("Month") %>% gather(State, Rates, c("ACT":"Australia")) 
