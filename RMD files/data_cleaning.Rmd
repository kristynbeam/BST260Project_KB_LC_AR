...
#We should show how we calculated the rate per 100,000 here - I assume it was just cases/100,000
head(aus_data)
...
# Rename provinces
aus_total <- recode(aus_total$State, "Australian Capital Territory" = "ACT", "New South Wales" = "NSW", "Northern Territory" = "NT", "Queensland" = "Qld", "South Australia" = "SA", "Tasmania" = "Tas", "Victoria" = "Vic", "Western Australia" = "WA")
