...
It appears that these NPIs have variable effects on COVID-19 incidence 
...
1. Australian Infectious Disease Data
2. Australian COVID data
3. Non-pharmaceutical policy interventions data

The Australian NHS website contains information for many infectious diseases as well as COVID-19 incidence tracking.
Based on the article published in Nature, a 
